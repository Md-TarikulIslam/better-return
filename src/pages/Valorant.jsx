...
import bg from '../assets/images/navbar/3.webp'
    ...
    return (
        <div className='mt-16'>
            <div className='relative bg-[#edf2f8]' style={backgroundStyle}>
                <div className='h-screen'>
                    <div className='z-30 absolute top-40 left-5 lg:left-40 font-bold text-lg tracking-widest '>
                        ...
                        <p className='text-7xl font-bold text-black'>Valorant</p>
                        <p className='text-xl mt-2 text-gray-900'>
                            From the biggest tournaments to the lower leagues, our AI-based platform helps you identify winning <br /> opportunities and make informed decisions.
                        </p>
                    </div>
                </div>
            ...
            <div className='max-w-screen-xl mx-auto'>
                <p className='text-7xl font-semibold text-[#333333] my-10 '>Valorant ROI</p>
            ...
            <div className='max-w-screen-xl mx-auto px-5 lg:px-0'>
                ...
                <div>
                    <p className='text-xl font-semibold'>Valorant</p>
                    <p className='text-lg text-[#687896] mt-2'>Based on the previous game's result, we use our AI algorithms to predict the winning team.</p>
                </div>

                <div>
                    <p className='text-xl font-semibold'>How can I invest in this?</p>
                    <p className='text-lg text-[#687896] mt-2'>It's easy, simple, and very secure. You just sign up for the package that fits your needs and the size of the investment. It's important that you make your choice for how much time you want to spend every day to grow your investment.</p>
                </div>
            ...
            <div className='max-w-screen-xl flex flex-col lg:flex-row px-5 lg:px-0 mx-auto justify-between gap-10  my-20'>
                <div className='flex-1'>
                    <p className='uppercase text-[#1386fd] tracking-widest font-semibold'>VALORANT</p>
                    <p className='text-5xl lg:text-7xl font-bold my-5'>Technical
                        predictions</p>
                    <p className='text-lg text-[#687896] mt-2'>Bet:ter Return team are using Artificial Intelligence (AI) and Machine Learning (ML) algorithm, considering the past 3 years of all kinds of Valorant tournaments data, and came up with several Radom Forest models and Neural Network models. Clustering all the model’s results we came up with a winning prediction or winning forecast accuracy. To achieve more accurate results we tune all the models every day before publishing them to our members. Depending on our advice we are sure that you can win the matches.</p>

                </div>
                <div className='flex-1'>
                    <img className='w-full h-full rounded-2xl' src={bg} alt="" />
                </div>
            </div>
            <ScrollRestoration />
        </div>
